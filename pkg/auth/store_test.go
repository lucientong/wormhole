...
func TestMemoryStore_TeamOperations(t *testing.T) {
...
func TestMemoryStore_RevokedTokenOperations(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
...
func TestMemoryStore_CleanupExpiredRevocations(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
...
func TestMemoryStore_UpdateTeam(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
